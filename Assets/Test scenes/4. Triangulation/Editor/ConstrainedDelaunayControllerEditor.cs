...
[CustomEditor(typeof(ConstrainedDelaunayController))]
public class ConstrainedDelaunayControllerEditor : Editor
{
    private ConstrainedDelaunayController triangulatePoints;



    private void OnEnable()
    {
        triangulatePoints = target as ConstrainedDelaunayController;
