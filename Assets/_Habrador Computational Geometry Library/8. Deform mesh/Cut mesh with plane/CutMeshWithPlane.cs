...
namespace Habrador_Computational_Geometry
{
    ...
    public static class CutMeshWithPlane 
    {
        ...
        public static List<Mesh> CutMesh(Mesh mesh, Transform meshTrans, Plane3 cutPlaneGlobal)
        {
            ...
            List<Edge3> newEdges = new List<Edge3>();
        ...
        private static void CutTriangleOneInFront(MyVector3 F1, MyVector3 B1, MyVector3 B2, MyMesh F_Mesh, MyMesh B_Mesh, List<Edge3> newEdges, Plane3 cutPlane)
        {
        ...
        private static void CutTriangleTwoInFront(MyVector3 F1, MyVector3 F2, MyVector3 B1, MyMesh F_Mesh, MyMesh B_Mesh, List<Edge3> newEdges, Plane3 cutPlane)
        {
            //Cut the triangle by using edge-plane intersection
            //Triangles in Unity are ordered clockwise, so form edges:
